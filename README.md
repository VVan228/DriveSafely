...
Также, за каждым новым пользователем закрепляется **Фабрика** по производству бензина, обладающая характеристиками максимальной вместимости (в литрах) и скоростью производства топлива (литров / час). Данные параметры аналогично задаются по умолчанию одинаковыми для всех новых игроков.
...
1. Увеличение уровня для Машины:
    ...
    - При переходе на новый уровень с игрока взимается плата, размер которой зависит от величины уровня
2. 
