...
1. Игрок заходит в раздел соревнований, выбирает доступный ему мир и соответствующую Машину
...
## Документация
Вы можете сгенерировать документацию с помощью '''Doxygen''', переместившись в папку с смарт-контрактами и набрав в командной строке 

solc --userdoc --devdoc FuelStationFactory.sol

В терминале будет выведено 2 вида документации - для разработчика и для пользователя.
